...
{
	$("#brand-pre").css('color', talisman_white);	// prefix. Title of the company	
	$("#brand-suf").css('color', talisman); 	// Suffix. Title of the company
	$('.header-txt').css('color',talisman);	// Texte inside the navbar 
	$('.navbar-default').css('background',talisman_dark);		// Navbar
...
function talisman_badge(){
	$('.badge').css('color', talisman_white); 		// bagde : little oval form	
